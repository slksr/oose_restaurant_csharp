...
namespace OOSE.RestaurantExercise.Logic
{
    ...
    {
        public const string Apron = "Put an apron on.";
        public const string Knifes = "Take a collection of knifes";
        public const string HardRock = "Set some hardrock music on";
